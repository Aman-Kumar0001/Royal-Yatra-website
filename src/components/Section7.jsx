            ...
            <div className=" mt-5">
                <footer className="text-center text-lg-start text-white" style={{ backgroundColor: '#111' }}>
                        ...
                        <div className="container text-center text-md-start mt-5">
                            <div className="row mt-3">
                                <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                    <h6 className="text-uppercase fw-bold"><i className="fa-solid fa-gem"></i>&nbsp;&nbsp;Royal <span className='text-danger'>Yatra</span></h6>
                                    <br />
                                    <p>
                    ...
                    <div className="text-center p-3" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
                        © 2024 Copyright:
                        <a className="text-white" href="https://github.com/Aman-Kumar0001">Amankumar.com</a>
                    </div>
                </footer>
            </div>
